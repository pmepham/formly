    ...
    <GuestLayout>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-3" action="#" method="POST">
                <div>
                    <label for="name" class="block text-sm/6 font-medium text-gray-900 dark:text-gray-100">Full name</label>
                    <div class="mt-2">
            ...
            <p class="mt-10 text-center text-sm/6 text-gray-500 dark:text-gray-400">
                ...
                {{ ' ' }}
                <RouterLink :to="Login"
                    class="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">Login in from here</RouterLink>
            </p>
        </div>
    </GuestLayout>
</template>
